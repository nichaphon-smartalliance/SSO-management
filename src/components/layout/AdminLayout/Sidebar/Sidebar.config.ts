...
export const sidebarMenuItems = [
  ...
  { key: "clients", label: TEXT_MENU.CLIENTS, href: "/clients", icon: AppWindow, roles: ["super_admin", "org_admin"] },
  { key: "requests", label: TEXT_MENU.REQUESTS, href: "/requests", icon: ClipboardList, roles: ["super_admin", "org_admin"] },
  { key: "permissions", label: TEXT_MENU.PERMISSIONS, href: "/permissions", icon: Shield, roles: ["super_admin", "org_admin"] },
  { key: "logs", label: TEXT_MENU.AUDIT_LOGS, href: "/logs", icon: ScrollText, roles: ["super_admin"] },
